...
const PatientStoryDetails = () => {
  ...
  const handleShare = async () => {
    ...
    try {
      ...
      // Clipboard can fail in some browsers; sharing count is still tracked below.
    }
    ...
    try {
      ...
      // Keep UX smooth even if shares API fails.
    }
  ...
  if (isLoading) {
    return (
      <main className="story-details-root w-full flex flex-col gap-5 p-4 sm:p-6 bg-[#FAFBFF] dark:bg-[#0B1120] rounded-[22px]">
        <StoryDetailsHeader />
