...
const MessagesSidebar = ({
  ...
  return (
    <aside
      className={`absolute lg:relative z-30 top-0 left-0 h-full w-[85vw] max-w-[320px] sm:w-80 bg-white dark:bg-[#111827] border-r border-gray-200 dark:border-gray-700 flex flex-col rounded-tl-3xl rounded-bl-3xl transition-transform duration-300 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0`}
    ...
    >
      ...
      <section className="px-4 pt-3 pb-3 shrink-0" aria-label="Search doctors">
        <div className="flex items-center gap-2 bg-gray-50 dark:bg-[#111827] border border-gray-200 dark:border-gray-700 rounded-3xl px-3 py-2.5 h-11">
          ...
          <input
            ...
            className="bg-transparent outline-none text-[#111827] dark:text-gray-100 w-full text-[14px] text-black-main-text dark:text-[#E2E8F0] placeholder:text-[var(--msg-muted-3)] font-normal"
          />
        </div>
      </section>
        ...
        {doctors.map((doc) => {
          ...
          return (
            <article
              ...
              className={`flex items-center gap-3 px-4 py-4 cursor-pointer transition-colors min-h-[5rem] ${isActive ? 'bg-indigo-50 dark:bg-indigo-950/50 border-r-4 border-[#333CF5] dark:border-[#60A5FA]' : 'border-b border-gray-50 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-[#1E293B] dark:bg-[#111827]'
                }`}
            >
      ...
      <footer className="bg-gray-50 dark:bg-[#111827] border-t border-gray-200 dark:border-gray-700 rounded-bl-3xl px-4 py-4 shrink-0">
