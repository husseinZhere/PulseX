...
const AddCommentSection = ({ newComment, onChange, onPost, userAvatar, userInitials }) => {
  return (
    <section className="bg-white dark:bg-[#111827] rounded-2xl p-5 border border-gray-100 dark:border-gray-800 shadow-sm dark:shadow-none" aria-label="Add a comment">
      ...
      <div className="flex items-start gap-3">
        ...
        <textarea
          ...
          className="flex-1 px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 bg-[#F9FAFB] dark:bg-[#0B1120] text-sm outline-none text-[#111827] dark:text-gray-100 resize-none focus:border-brand-main transition"
        />
      </div>
